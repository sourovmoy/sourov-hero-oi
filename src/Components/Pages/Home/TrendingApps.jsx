...
const TrendingApps = ({ app }) => {
  return (
    <div className="text-center shadow-lg p-2 rounded-md bg-white">
      <img className="p-2 border-[#FFF0E1]" src={app.image} alt="" />
      <h3 className="font-semibold text-xl my-2">{app.title}</h3>
